...
#   -v, --version VERSION         Version for artifacts folder (default: 1.0.0)
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    -h|--help)
      ...
      echo "  -v, --version VERSION         Version for artifacts folder (default: 1.0.0)"
      echo "  -h, --help                    Show this help message"
      echo ""
      echo "Examples:"
      echo "  $0                                    # Deploy pi5-support to default servers"
      echo "  $0 -b main -v 2.0.0                  # Deploy main branch as v2.0.0"
